namespace Gestione {
	...
	public class GeCoModel : DbContext {
		// Il contesto è stato configurato per utilizzare una stringa di connessione 'GeCoModel' dal file di configurazione 
		// dell'applicazione (App.config o Web.config). Per impostazione predefinita, la stringa di connessione è destinata al 
		// database 'Gestione.GeCoModel' nell'istanza di LocalDb. 
		// 
		// Per destinarla a un database o un provider di database differente, modificare la stringa di connessione 'GeCoModel' 
