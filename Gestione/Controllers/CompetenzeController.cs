...
namespace Gestione.Controllers {
	public class CompetenzeController : ApiController {
		...
		[HttpDelete][Route("api/CV/{idCV}/Competenza/Del/{idCompetenza}")]      //FINIRE
